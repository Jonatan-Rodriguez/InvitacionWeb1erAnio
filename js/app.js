const seccionesPaginas = new fullpage('#fullpage',{
    ...
    navigation: true,
    anchors: ['inicio', 'infoEvento', 'galeria','confirmacion'],
    navigationTooltips: ['Inicio', 'Donde y cuando', 'Galeria de fotos', 'Confirmacion'],
...
countdown('Jun 30 2023 15:00:00 GMT-0300', 'clock', '¡Feliz cumpleaños!');
